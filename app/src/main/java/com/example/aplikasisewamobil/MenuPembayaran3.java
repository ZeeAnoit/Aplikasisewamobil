        ...
        userOrderRef.push().setValue(myOrder)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(MenuPembayaran3.this, "Data berhasil disimpan ke Firebase", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MenuPembayaran3.this, "Gagal menyimpan data ke Firebase", Toast.LENGTH_SHORT).show();
                    }
                });
    }
