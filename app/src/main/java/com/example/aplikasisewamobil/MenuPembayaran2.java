...
public class MenuPembayaran2 extends AppCompatActivity {
    private TextView totalPriceTextView;
    private Button btnDatePicker;
    private int hargaTotal = 0;
    private String namamobil = "ALL NEW RUSH";  // Default car name
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_pembayaran2);

        Spinner durationSpinner = findViewById(R.id.duration2);
        totalPriceTextView = findViewById(R.id.total_price_textview2);
        btnDatePicker = findViewById(R.id.btn_date_picker2); // Button for date picker
        ...
        Button btnbayar = findViewById(R.id.btnbayar2);
    ...
    private void showDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(MenuPembayaran2.this, new DatePickerDialog.OnDateSetListener() {
            @Override
        ...
        userOrderRef.push().setValue(myOrder)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(MenuPembayaran2.this, "Data berhasil disimpan ke Firebase", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MenuPembayaran2.this, "Gagal menyimpan data ke Firebase", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void redirectToPaymentDone() {
        Intent intent = new Intent(MenuPembayaran2.this, PembayaranDone.class);
